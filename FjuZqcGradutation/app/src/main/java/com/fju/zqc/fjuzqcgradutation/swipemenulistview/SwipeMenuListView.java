package com.fju.zqc.fjuzqcgradutation.swipemenulistview;
 ...
 * 
 */
public class SwipeMenuListView extends ListView implements ListView.OnScrollListener {
	...
	private ISwipeLoadListener iLoadListener;
	...
	public void setInterface(ISwipeLoadListener iLoadListener){
	...
	public interface ISwipeLoadListener{
		public void onLoad();
	}
}
