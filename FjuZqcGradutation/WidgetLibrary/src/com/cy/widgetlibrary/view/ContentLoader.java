 ...
 */
public class ContentLoader extends View {
    ...
    public ContentLoader(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public ContentLoader(Context context, AttributeSet attrs, int defStyleAttr) {
